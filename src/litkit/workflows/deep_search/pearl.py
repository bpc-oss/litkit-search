...
STOPWORDS = {
    ...
    "under", "up", "while", "into", "upon", "also", "however",
    "thus", "hence", "therefore", "using", "based", "well",
    "study", "studies", "results", "method", "methods", "data",
    "analysis", "analyze", "show", "shown", "found", "demonstrate",
    "demonstrated", "suggest", "suggested", "indicate", "indicated",
    "observe", "observed", "assess", "assessed", "evaluate",
    "evaluated", "examine", "examined", "investigate", "investigated",
    "perform", "performed", "identify", "identified", "provide",
    "provided", "reveal", "revealed", "lead", "led", "effect",
    "effects", "role", "roles", "level", "levels", "change", "changes",
    "increase", "increased", "decrease", "decreased", "significant",
